 ...
 */
package com.paiondata.fiore.config;
...
/**
 * {@link OpenaiConfig} provides an interface for retrieving configuration values, allowing for implicit type
 * conversion, defaulting, and use of a runtime properties interface to override configured settings.
 * <p>
 * {@link OpenaiConfig} tries to load the configurations from several sources in the following order:
 * <ol>
...
public interface OpenaiConfig extends Config {
